  ...
  return (
    <div className="min-h-screen bg-background bg-mesh">
      ...
      <div className="px-6 pt-4">
        ...
        <form onSubmit={(e) => { e.preventDefault(); nav({ to: "/home" }); }} className="mt-6 space-y-3">
          ...
          <button type="submit" className="w-full bg-gradient-warm text-white font-semibold py-4 rounded-2xl shadow-glow active:scale-[0.98] transition">
            Sign In
          </button>
        </form>
        ...
        <button className="w-full flex items-center justify-center gap-3 py-3.5 bg-card border border-border rounded-2xl font-medium text-sm active:scale-[0.98] transition">
