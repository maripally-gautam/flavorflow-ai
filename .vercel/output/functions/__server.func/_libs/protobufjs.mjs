...
function requirePatterns() {
  ...
  (function(exports) {
    ...
    patterns2.unsafePropertyRe = /^(?:__proto__|prototype|constructor)$/;
  })(patterns);
  return patterns;
}
var namespace;
      ...
      fromObject: function(object2, depth) {
        if (object2 && object2["@type"]) {
          ...
          if (type2) {
            ...
            return this.create({
              type_url,
              value: type2.encode(type2.fromObject(object2, nextDepth)).finish()
            });
          }
        }
...
function requireUtil() {
  ...
  var reservedRe = util$1.patterns.reservedRe, unsafePropertyRe = util$1.patterns.unsafePropertyRe;
